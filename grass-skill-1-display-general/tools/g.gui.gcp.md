...
```python
tools.g_gui_gcp(verbose=None,quiet=None,superquiet=None)
```
...
- [Official g.gui.gcp manual](https://grass.osgeo.org/grass-devel/manuals/g.gui.gcp.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/g.gui.gcp.html#__tabbed_1_3)
