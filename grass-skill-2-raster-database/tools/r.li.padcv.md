...
```python
tools.r_li_padcv(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.padcv manual](https://grass.osgeo.org/grass-devel/manuals/r.li.padcv.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.padcv.html#__tabbed_1_3)
