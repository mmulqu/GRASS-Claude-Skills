...
```python
tools.r_li_richness(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
r.li.richness calculates the "richness diversity index" as: with:
...
(Italy). Commission from Faunalia Pontedera (PI), Italy ( )

---

## Resources

- [Official r.li.richness manual](https://grass.osgeo.org/grass-devel/manuals/r.li.richness.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.richness.html#__tabbed_1_3)
