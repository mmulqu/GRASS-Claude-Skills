...
```python
tools.r_rescale(input,from=None,output,to,title=None,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
layer with a large range of category values (e.g., elevation). Rescaled map layers are appropriate for use in such GRASS commands
as r.stats , r.report , and r.coin .
...
- [`r.rescale.eq`](https://grass.osgeo.org/grass-devel/manuals/r.rescale.eq.html)
...
- [Official r.rescale manual](https://grass.osgeo.org/grass-devel/manuals/r.rescale.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.rescale.html#__tabbed_1_3)
