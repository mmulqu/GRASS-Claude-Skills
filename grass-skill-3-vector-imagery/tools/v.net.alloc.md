...
```python
tools.v_net_alloc(input,output,method="from",center_cats,arc_layer="1",arc_type="line,boundary",node_layer="2",arc_column=None,arc_backward_column=None,node_column=None,turn_layer="3",turn_cat_layer="4",flags=None,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
5. **`arc_layer : str, required`**
   - Arc layer
   - Vector features can have category values in different layers. This number determines which layer to use. When used with direct OGR access this is the layer name.
   - Used as: input, layer

6. **`arc_type : str | list[str], required`**
   - Arc type
   - Input feature type
   - Allowed values: line, boundary

7. **`node_layer : str, required`**
   - Node layer
   - Vector features can have category values in different layers. This number determines which layer to use. When used with direct OGR access this is the layer name.
   - Used as: input, layer

8. **`arc_column : str, optional`**
   - Arc forward/both direction(s) cost column (number)
   - Used as: input, dbcolumn, name

9. **`arc_backward_column : str, optional`**
   - Arc backward direction cost column (number)
   - Used as: input, dbcolumn, name

10. **`node_column : str, optional`**
...
13. **`flags : str, optional`**
   ...
   - t
   - Use turntable
   - *(see [full docs](https://grass.osgeo.org/grass-devel/manuals/v.net.alloc.html#__tabbed_2_3) for all details)*
...
*Showing 10 of 17 parameters - see [full documentation](https://grass.osgeo.org/grass-devel/manuals/v.net.alloc.html#__tabbed_2_3) for all*
...
center . The ocat field holds the original line category in arc_layer and the center field holds the center category in node_layer . Additionally, original line categories are copied from
...
- [Official v.net.alloc manual](https://grass.osgeo.org/grass-devel/manuals/v.net.alloc.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/v.net.alloc.html#__tabbed_1_3)
