...
```python
tools.r_li_mpa(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
attribute of all the non-null cells in the sampling area as: with:
...
- [Official r.li.mpa manual](https://grass.osgeo.org/grass-devel/manuals/r.li.mpa.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.mpa.html#__tabbed_1_3)
