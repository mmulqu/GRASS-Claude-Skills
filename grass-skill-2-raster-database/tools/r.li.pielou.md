...
```python
tools.r_li_pielou(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
r.li.pielou calculates the "Pielou's diversity index" as: with:
...
- [Official r.li.pielou manual](https://grass.osgeo.org/grass-devel/manuals/r.li.pielou.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.pielou.html#__tabbed_1_3)
