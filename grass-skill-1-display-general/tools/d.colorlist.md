...
```python
tools.d_colorlist(separator="comma",verbose=None,quiet=None,superquiet=None)
```

### Parameters

1. **`separator : str, optional`**
   - Field separator
...
- [Official d.colorlist manual](https://grass.osgeo.org/grass-devel/manuals/d.colorlist.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/d.colorlist.html#__tabbed_1_3)
