...
```python
tools.r_out_xyz(input,output=None,separator="pipe",flags=None,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.out.xyz manual](https://grass.osgeo.org/grass-devel/manuals/r.out.xyz.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.out.xyz.html#__tabbed_1_3)
