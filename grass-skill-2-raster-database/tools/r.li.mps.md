...
```python
tools.r_li_mps(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.mps manual](https://grass.osgeo.org/grass-devel/manuals/r.li.mps.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.mps.html#__tabbed_1_3)
