...
```python
tools.d_what_rast(map,verbose=None,quiet=None,superquiet=None)
```
...
- [Official d.what.rast manual](https://grass.osgeo.org/grass-devel/manuals/d.what.rast.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/d.what.rast.html#__tabbed_1_3)
