...
```python
tools.r_li_padrange(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.padrange manual](https://grass.osgeo.org/grass-devel/manuals/r.li.padrange.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.padrange.html#__tabbed_1_3)
