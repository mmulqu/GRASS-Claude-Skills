...
```python
tools.r_li_patchdensity(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.patchdensity manual](https://grass.osgeo.org/grass-devel/manuals/r.li.patchdensity.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.patchdensity.html#__tabbed_1_3)
