...
```python
tools.r_li_simpson(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
r.li.simpson calculates the "Simpson's diversity index" as: with:
...
- [Official r.li.simpson manual](https://grass.osgeo.org/grass-devel/manuals/r.li.simpson.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.simpson.html#__tabbed_1_3)
