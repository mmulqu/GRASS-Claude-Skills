...
```python
tools.r_li_shannon(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
r.li.shannon calculates the "Shannon's diversity index" as: with:
...
- [Official r.li.shannon manual](https://grass.osgeo.org/grass-devel/manuals/r.li.shannon.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.shannon.html#__tabbed_1_3)
