...
```python
tools.r_li_shape(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.shape manual](https://grass.osgeo.org/grass-devel/manuals/r.li.shape.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.shape.html#__tabbed_1_3)
