...
```python
tools.r_li_padsd(input,config,output,overwrite=None,verbose=None,quiet=None,superquiet=None)
```
...
- [Official r.li.padsd manual](https://grass.osgeo.org/grass-devel/manuals/r.li.padsd.html)
- [grass.tools API documentation](https://grass.osgeo.org/grass-devel/manuals/r.li.padsd.html#__tabbed_1_3)
